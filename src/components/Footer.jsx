export default function Footer({ onOpenFeedback, onOpenFeedbackViewer }) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <ul className="space-y-2 text-zinc-500">
              ...
              <li>
                <button
                  ...
                  className="hover:text-indigo-600 transition-colors text-left flex items-center gap-1.5 font-medium text-zinc-700"
                >
              ...
              <li>
                <button
                  ...
                  className="hover:text-indigo-600 transition-colors text-left flex items-center gap-1.5"
                >
                  <svg className="w-3.5 h-3.5 text-zinc-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="pt-8 flex flex-wrap items-center justify-between gap-4 text-xs text-zinc-500">
          ...
          <div className="flex items-center gap-6 font-mono text-[11px]">
            <button onClick={onOpenFeedbackViewer} className="hover:text-zinc-900 transition-colors flex items-center gap-1 text-zinc-600">
