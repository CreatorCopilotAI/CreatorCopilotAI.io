            ...
            <nav className="hidden lg:flex items-center gap-1 text-[13px] font-medium text-zinc-600">
              ...
              >
                <button
                  ...
                  className={`flex items-center gap-1 px-3 py-1.5 rounded-lg transition-colors hover:text-zinc-900 hover:bg-zinc-100/70 ${
                    platformOpen ? 'text-zinc-900 bg-zinc-100/70' : ''
                  }`}
                >
                  Platform
                  <svg
